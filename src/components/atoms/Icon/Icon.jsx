...
const ICONS = {
  ...
  tidal: (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M12.012 3.992L8.008 7.996 4.004 3.992 0 7.996 4.004 12l4.004-4.004L12.012 12l-4.004 4.004L12.012 20l4.004-4.004L12.012 12l4.004-4.004L12.012 3.992zM16.016 7.996l4.004-4.004L24 7.996l-4.004 4.004L16.016 7.996z" />
    </svg>
  ),
  bandcamp: (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
...
export default function Icon({ name, size = "md", className = "", label }) {
